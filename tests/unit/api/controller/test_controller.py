...
from src.api.controller import ApiController, _extract_jobs
...
class TestApiController:
    ...
    def test_list_carriers_returns_registry_names(self):
        ...
        controller = ApiController()
        with patch("src.api.controller.carriers.CarrierRegistry") as reg:
    ...
    def test_convert_success_returns_universal_json(self):
        ...
        with patch("src.api.controller.convert.CarrierRegistry") as reg:
    ...
    def test_carrier_openapi_yaml_returns_yaml_string(self):
        ...
        with patch("src.api.controller.carriers.Path", return_value=path_mock):
            with patch("builtins.open", MagicMock()) as open_mock:
                ...
                with patch(
                    "src.api.controller.carriers.generate_openapi",
                    return_value=fake_spec,
                ):
                    with patch(
                        "src.api.controller.carriers.UniversalCarrierFormat"
                    ) as ucf:
