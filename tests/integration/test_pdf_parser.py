...
class TestPdfParserIntegration:
    ...
    def test_extract_text_contains_api_keywords(self, parser, example_pdf_path):
        ...
        assert len(found_keywords) > 0, f"No API keywords found in extracted text. Found: {found_keywords}"
...
class TestPdfParserIntegration:
    ...
    def test_extract_text_handles_multi_page_pdf(self, parser, example_pdf_path):
        ...
        if metadata['page_count'] > 1:
            ...
            assert len(text) > 100, "Multi-page PDF should have substantial text content"
    
    def test_extract_text_with_tables_from_real_pdf(self, parser_with_tables, example_pdf_path):
        """
