...
class PdfParserService:
    ...
    def extract_text(self, pdf_path: str) -> str:
        ...
        try:
            ...
            logger.info(
                ...
                extra={'text_length': len(text), 'pages': self._get_page_count(pdf_path)}
            )
    ...
    def extract_metadata(self, pdf_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Failed to extract metadata from PDF: {pdf_path}", exc_info=True)
    ...
    def _extract_text_from_pdf(self, pdf_path: str) -> str:
        ...
        try:
            ...
            if not combined_text.strip():
                ...
                raise ValueError(f"PDF appears to be empty or contains only images: {pdf_path}")
